    ...
    if(tipoUser == "prestador"){
        return(
            <div className="sec-bg-color shadow-xl rounded-lg" style={{padding: "40px"}}>
                {/* Cabeçalho */}
                <div className="mb-6">
                    <h1 className="text-center font-bold">Professional Dashboard</h1>
                    <p className="text-gray-400 text-center">Welcome, [Professional name]! Here is everything you got for today.</p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                    <div className="shadow-lg rounded-lg p-4 flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-400">Today Schedules</p>
                    ...
                    <div className="shadow-lg rounded-lg p-4 flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-400">Attended customers</p>
                ...
                {/* Lista de Agendamentos */}
                    <h2 className="text-xl font-bold mb-4 text-center">Agendamentos de Hoje</h2>
